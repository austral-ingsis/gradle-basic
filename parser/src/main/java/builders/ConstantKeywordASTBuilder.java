...
import ast.AST;
import ast.ConstantKeywordAST;
import exceptions.ASTBuildException;
import exceptions.BadTokenException;
import token.Token;

public class ConstantKeywordASTBuilder implements ASTBuilder {
  private final Token value;
  private transient ASTBuilder child;

  public ConstantKeywordASTBuilder(Token value) {
    this.value = value;
  }

  public ConstantKeywordASTBuilder(Token value, ASTBuilder child) {
    this.value = value;
    this.child = child;
  }
  ...
  public ASTBuilder addASTBuilder(NumberASTBuilder newAST) throws BadTokenException {
    ...
    return new ConstantKeywordASTBuilder(value, child.addASTBuilder(newAST));
  }
  ...
  public ASTBuilder addASTBuilder(IdentifierASTBuilder newAST) throws BadTokenException {
    if (child == null) {
      return new ConstantKeywordASTBuilder(value, newAST);
    }
    return new ConstantKeywordASTBuilder(value, child.addASTBuilder(newAST));
  }
  ...
  public AST buildAST() throws ASTBuildException {
    return new ConstantKeywordAST(getValue(), child.buildAST());
  }
}
